...
<aside class="main-sidebar sidebar-dark-primary bg-black elevation-4">
  <a href="dashboard.php" class="brand-link logo-switch bg-black">
    <h4 class="brand-image-xl logo-xs mb-0 text-center"><b>CWEB</b></h4>
    <h4 class="brand-image-xl logo-xl mb-0 text-center">Paciente <b>CWEB</b></h4>
  </a>
