...
<head>
  ...
  <title>Pacientes - Sistema de Gestión de Pacientes</title>
      ...
      <section class="content">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">Agregar Pacientes</h3>
          ...
          <div class="card-body">
            <form method="post">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                  <label>DNI</label>
                  <input type="text" id="cnic" name="cnic" required="required" class="form-control form-control-sm rounded-0" />
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                  ...
                  <input type="text" id="phone_number" name="phone_number" required="required" class="form-control form-control-sm rounded-0" />
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                  <label>Género</label>
              ...
              <div class="row">
                ...
                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12">
                  <button type="submit" id="save_Patient" name="save_Patient" class="btn btn-primary btn-sm btn-flat btn-block">Guardar</button>
                </div>
              </div>
            </form>
          </div>
