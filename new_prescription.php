...
if (isset($_POST['submit'])) {
  ...
  try {
    ...
    $message = 'Medicamento del paciente almacenado correctamente';
...
<head>
  ...
  <title>Nueva Prescripción - Sistema de Gestión de Pacientes</title>
      ...
      <section class="content">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">Agregar Nueva Prescripción</h3>
            ...
            <form method="post">
              <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                  <label>Presión de la Sangre</label>
              ...
              <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                  <label>Selecciona Medicina</label>
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <button type="submit" id="submit" name="submit" class="btn btn-primary btn-sm btn-flat btn-block">Guardar</button>
                </div>
              </div>
            </form>
    ...
    $(document).ready(function() {
      ...
      $("#add_to_list").click(function() {
        ...
        if (medicineName !== '' && packing !== '' && quantity !== '' && dosage !== '') {
          ...
          showCustomMessage('Por favor rellena todos los campos');
        }
